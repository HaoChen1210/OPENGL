...
public class PolygonalSceneObject extends SceneObject {
	 ...
	 * 
	 * The line and fill colors can possibly be null, in which case that part of
	 ...
	 *            The outline color
	 */
	public PolygonalSceneObject(SceneObject parent, Polygon2D polygon, Color fillColor, Color lineColor) {
		super(parent);
	 ...
	 * Draw the polygon
	 * 
	 * if the fill color is non-null, draw the polygon filled with this color if
	 * the line color is non-null, draw the outline with this color
	 * 
	 */
	@Override
